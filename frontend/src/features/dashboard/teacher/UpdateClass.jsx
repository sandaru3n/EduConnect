...
const EditClass = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setNotification({ message: "Class updated successfully! Redirecting...", type: "success" });
            ...
            <div className="flex min-h-screen">
                        ...
                        {error ? (
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
                                className="text-red-600 bg-red-100 p-3 rounded-md text-center shadow-sm max-w-lg mx-auto"
                            >
                                {error}
                            </motion.div>
                        ) : (
