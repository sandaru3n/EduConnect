...
import { CreditCard, ArrowBack, CheckCircle } from '@mui/icons-material';
...
const StudyPackPaymentForm = () => {
    ...
    useEffect(() => {
        const fetchStudyPackDetails = async () => {
            try {
                ...
                alert('Failed to load study pack details. Please try again.');
            }
        };
    ...
    const handleCloseSuccessModal = () => {
        ...
        navigate('/student/purchased-studypacks'); // Redirect after closing the modal
    };
        ...
        >
            ...
            >
                ...
                <Grid container spacing={0} sx={{ pt: 1 }}>
                    {/* Left Section: Study Pack Details */}
                    <Grid item xs={12} md={5}>
                        ...
                        >
                            <Typography variant="h6" sx={{ fontWeight: 'bold', color: '#000', mb: 2 }}>
                                Purchase {studyPackDetails?.title}
                            </Typography>
                            {studyPackDetails ? (
                                <>
                                    {/* Study Pack Cover Photo */}
                                    <Box
                                        sx={{
                                            width: '100%',
                                            height: 150,
                                    ...
                                    >
                                        <img
                                            src={studyPackDetails.coverPhoto || 'https://via.placeholder.com/300x150?text=Study+Pack+Cover'}
                                            alt="Study Pack Cover"
                                            style={{ width: '100%', height: '100%', objectFit: 'cover' }}
                                            onError={(e) => (e.target.src = 'https://via.placeholder.com/300x150?text=Study+Pack+Cover')}
                                        />
                                    </Box>

                                    <Typography variant="body1" sx={{ color: '#6b7280' }}>
                                        {studyPackDetails.title}
                                    </Typography>
                                    <Typography variant="body1" sx={{ color: '#6b7280' }}>
                                        Subject: {studyPackDetails.subject}
                                    </Typography>
                                    <Divider sx={{ my: 1 }} />
                                ...
                                <FormControlLabel
                                    ...
                                    label={
                                        <Typography variant="body2" sx={{ color: '#6b7280' }}>
                                            By purchasing, you agree to EduConnect's <a href="/terms" target="_blank" style={{ color: '#3b82f6' }}>Terms of Use</a> and <a href="/privacy" target="_blank" style={{ color: '#3b82f6' }}>Privacy Policy</a>.
                                        </Typography>
                                    }
                                    sx={{ mb: 2 }}
                                />
                ...
                <Fade in={showSuccessModal}>
                    ...
                    >
                        ...
                        <Typography variant="body1" sx={{ color: '#6b7280', mb: 3 }}>
                            You have successfully purchased the study pack "{studyPackDetails?.title}". Enjoy your learning journey!
                        </Typography>
                        <Button
                            variant="contained"
...
export default StudyPackPaymentForm;