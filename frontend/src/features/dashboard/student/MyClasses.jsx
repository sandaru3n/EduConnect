                            ...
                            >
                                {inactiveSubscriptions.map((sub) => (
                                    <motion.div
                                        ...
                                        variants={cardVariants}
                                        whileHover="hover"
                                        className="bg-gradient-to-br from-red-50 to-orange-50 border border-gray-200 rounded-xl p-5 relative overflow-hidden"
                                    >
                                        <div className="absolute right-0 top-0 h-16 w-16">
                                        ...
                                        <button
                                            ...
                                            className="w-full px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 transition-all duration-200 text-sm font-medium flex items-center justify-center shadow-sm group"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
