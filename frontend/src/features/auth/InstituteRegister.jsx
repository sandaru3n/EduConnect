...
const InstituteRegister = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        email: "",
        password: "",
        confirmPassword: "", // New field for Step 2
        subscriptionId: "",
        cardNumber: "",
        expiryDate: "",
        cvv: "",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const { data } = await axios.post("http://localhost:5000/api/auth/register", {
                ...
                addressLine1: formData.addressLine1, // New field
                addressLine2: formData.addressLine2, // New field
                district: formData.district, // New field
                zipCode: formData.zipCode, // New field
            ...
            >
                ...
                <div className="space-y-1">
                    ...
                    <div className="text-center">
                        ...
                        <h2 className="mt-1 text-lg font-semibold text-gray-800">Institute Registration</h2>
                    ...
                    <div className="space-y-4">
                        {step === 1 && (
                            <>
                                ...
                                <div>
                                    <h3 className="text-base font-semibold text-gray-800 mb-2">Institute Details</h3>
